    ...
    padding: EdgeInsets.all(16),
      child:Column(
        children: <Widget>[
          ...
          _mainbuildUserInfo('https://st2.depositphotos.com/2069237/5489/i/450/depositphotos_54892607-stock-photo-male-runner-in-san-francisco.jpg', 'Ihor'),
          _mainbuildContentCard('https://st.depositphotos.com/2069237/2227/i/450/depositphotos_22277851-stock-photo-running-male-runner.jpg'),
        ],
      ),
      )
      )
...
Widget _mainbuildUserInfo(String url, String name) {
    return Container(
      child: Row(
        children: [ ClipOval(
            child: CachedNetworkImage(
              imageUrl: url, //'https://t4.ftcdn.net/jpg/02/24/86/95/360_F_224869519_aRaeLneqALfPNBzg0xxMZXghtvBXkfIA.jpg',
              width: 50,
              height: 50,
              fit: BoxFit.cover,
              placeholder: (context, url) => CircularProgressIndicator(), // Loading indicator
            ...
            child: Stack(
              ...
              children: [
                Container(
                  ...
                  height: 500,
                  color: Colors.grey[200],
                  child: ImageTap(url: url, text: 'Your profile')//'https://t3.ftcdn.net/jpg/07/18/67/92/360_F_718679203_1mFavXgopwxYctQHrX9V6GgcX0oZ6OqM.jpg', text:'Hello')
                ),
                Positioned(
                  bottom: 14,
                  left: 13,
